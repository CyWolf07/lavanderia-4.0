...
@section('title', 'Lavandería Registro')
...
<div class="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
    <div class="brand-hero overflow-hidden rounded-[2rem] text-white shadow-2xl shadow-sky-200/70">
        <div class="grid gap-10 px-8 py-12 lg:grid-cols-[1.1fr_0.9fr] lg:px-14 lg:py-16">
            <div>
                <p class="text-sm font-semibold uppercase tracking-[0.45em] text-sky-100">Sistema de lavandería</p>
                <h1 class="mt-5 max-w-3xl text-4xl font-black leading-tight text-white sm:text-5xl">
                    Registra la producción por empleado y cierra cada quincena con informe listo para imprimir.
                </h1>
            ...
            <div class="grid gap-4 sm:grid-cols-2">
                <div class="rounded-3xl border border-white/15 bg-white/12 p-6 backdrop-blur-md">
                    ...
                    <p class="mt-2 text-sm text-sky-50/95">Nombre, cédula, contacto y rol en una sola administración.</p>
                </div>
                <div class="rounded-3xl border border-white/15 bg-white/12 p-6 backdrop-blur-md">
                    <p class="text-sm font-semibold text-emerald-100">Producción</p>
                    <h2 class="mt-3 text-2xl font-bold text-white">Totales por día</h2>
                ...
                <div class="rounded-3xl border border-white/15 bg-white/12 p-6 backdrop-blur-md">
                    ...
                    <h2 class="mt-3 text-2xl font-bold">QUINCENA</h2>
                    <p class="mt-2 text-sm text-sky-50/95">El historial queda guardado por quincenas para consulta posterior.</p>
                </div>
                <div class="rounded-3xl border border-white/15 bg-white/12 p-6 backdrop-blur-md">
                    <p class="text-sm font-semibold text-emerald-100">Informes</p>
                    <h2 class="mt-3 text-2xl font-bold text-white">Impresión inmediata</h2>
